...
begin
  ...
  // Se chegar até aqui, tem que tentar autenticar
...
begin
  if (not AnsiSameText(edSenha.Text, 'Usuário')) and (edUsuario.Text = '') then
    edUsuario.Text := 'Usuário';
end;
